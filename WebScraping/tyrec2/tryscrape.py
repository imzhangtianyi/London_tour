...
#=====================================================================================================================
    try:
        conn = pg2.connect(host="test.cd6otpnh2nbb.us-east-2.rds.amazonaws.com",database="test", user="test", password="testtest",connect_timeout=10)
        cur = conn.cursor()
        sql = """INSERT INTO a2(attraction, ranking, rating, review_num, address, street, locality, category, phone, duration, hours, neighborhood, description, tags, languages) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
        ...
        logging.exception('Data base error on page %d: %s', page, attraction)
#=====================================================================================================================
# Reviews
#=====================================================================================================================
