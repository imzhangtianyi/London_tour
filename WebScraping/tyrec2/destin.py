...
for x in u:
    page = page + 1
    try:
        page_recq = requests.get('https://www.tripadvisor.com' + x[0], timeout=100)
        time.sleep(1)
    except:        
        logging.exception("Fail to requestion link: %s, page: %d", x[0], page)
        break
...
#=====================================================================================================================
    try:
        ...
        attraction = 'missing'
        logging.error("Fail to aquire heading: page: %d", page)
#=====================================================================================================================
# Popularity ranking
#=====================================================================================================================
    try:
...
#=====================================================================================================================
    try:
        ...
        cur = conn.cursor()
        sql = """INSERT INTO destination0(attraction, ranking, rating, review_num, address, street, locality, category, phone, duration, hours, neighborhood, description, tags, languages, sitelink) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
        cur.execute(sql, (attraction, ranking, rating, nreview, address, street, locality, cate, ph, duration, hrs, neighborhood, desc, tags, languages, x[0]))
        conn.commit()
    except:
        logging.exception('Data base (dest) error on page %d: %s', page, attraction)
#=====================================================================================================================
# Reviews
#=====================================================================================================================
...
#=====================================================================================================================
        try:
            ...
            logging.error("Fail to aquire userid: site: %s", x[0])
            continue
...
#=====================================================================================================================
        try:
            conn = pg2.connect(host="tourlondon.cd6otpnh2nbb.us-east-2.rds.amazonaws.com",database="london", user="zty", password="54321zty",connect_timeout=10)
            cur = conn.cursor()
            sql = """INSERT INTO review0(userID, attraction, user_location, user_Contributions, user_UpVotes, viaMobile, review_quote, review_content, reviewlink) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s);"""
            cur.execute(sql, (user, attraction, user_location, user_Contributions, user_UpVotes, viamobile, quote, review, rlink))
            conn.commit()
        except:
            logging.exception('Data base (revi) error on page %d: %s', page, attraction)
    print page