...
#=====================================================================================================================
    try:
        ...
        cur = conn.cursor()
        sql = """INSERT INTO destinations(attraction, ranking, rating, review_num, address, street, locality, category, phone, duration, hours, neighborhood, description, tags, languages) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
...
#=====================================================================================================================
        try:
            sql = """INSERT INTO reviews(userID, attraction, user_location, user_Contributions, user_UpVotes, viaMobile, review_quote, review_content) VALUES(%s, %s, %s, %s, %s, %s, %s, %s);"""
